...
//        g.add(new Ball(new Point2D(90, 90)));
        ...
        System.out.println("------------------------------------------------"); Player player = new Player("Red Player", Color.RED, new Point2D(100,100),0);
        player.speed = 10;
        player.direction = 0;
        g.add(player);
        ...
        System.out.println("\nHere are the Harmful Objects:"); Harmful[] dangerousStuff = g.harmfulObjects();
        for (Harmful d: dangerousStuff)
            System.out.println(" " + d);

        // Assess the current amount of danger
        System.out.println("\nCurrent Danger Assessment:"); System.out.println(g.assessDanger());
